...
class WishlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wishlist" do
    assert_difference("Wishlist.count") do
      post wishlists_url, params: { wishlist: { merchant_id: @wishlist.merchant_id, order: @wishlist.order, product_id: @wishlist.product_id } }
    end
  ...
  test "should update wishlist" do
    patch wishlist_url(@wishlist), params: { wishlist: { merchant_id: @wishlist.merchant_id, order: @wishlist.order, product_id: @wishlist.product_id } }
